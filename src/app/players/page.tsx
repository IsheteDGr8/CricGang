...
const PlayerList = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h2 className="text-3xl font-bold text-center mb-8 text-blue-800">Meet the Players</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {players.map((player) => (
          <Link
            key={player}
            href={`/players/${player}`}
            className="bg-white border border-gray-300 rounded-lg p-4 shadow hover:shadow-lg text-center"
          >
            <img
